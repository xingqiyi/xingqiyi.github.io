  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        <ScrollView style={{ backgroundColor: "rgba(240,240,240,0.4)" }}>
          <Image
            style={styles.myBgImage}
            source={require("../images/img_my_bg.png")}
          >
            <TouchableOpacity
            ...
            >
              {user.avatar
                ...
                : <Image
                    style={styles.headIcon}
                    source={require("../images/img_default_head.png")}
                  />}
              {user.id
          ...
          <Text
            style={{
              ...
              padding: 10,
              fontSize: 18,
              marginLeft: Common.window.width - 30
            }}
          >
            >
          </Text>
          ...
          >
            <TextButton onPress={() => {}} text={"物流"} upText={"0"} />
            <TextButton onPress={() => {}} text={"物流"} upText={"0"} />
            <TextButton onPress={() => {}} text={"物流"} upText={"0"} />
            <ImageButton
              imageStyle={{
          ...
          >
            ...
            />
            <Text style={{ marginLeft: 10 }}>每日签到</Text>
            <Text
              style={{
                position: "absolute",
                padding: 12,
          ...
          >
            <Image
              ...
              style={{ width: 30, height: 30, marginLeft: 20 }}
            />
            <Text style={{ marginLeft: 10 }}>联系客服</Text>
            <Text
              style={{
                position: "absolute",
                padding: 12,
